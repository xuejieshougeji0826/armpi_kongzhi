...
fig = plt.figure()
axA = fig.add_subplot(5, 1, 1, xlim=(0, 0.2), ylim=(0, 10))
axB = fig.add_subplot(5, 1, 2, xlim=(0, 0.2), ylim=(0, 10))
axX = fig.add_subplot(5, 1, 3, xlim=(0, 0.2), ylim=(0, 10))
axY = fig.add_subplot(5, 1, 4, xlim=(0, 0.2), ylim=(0, 10))
axZ = fig.add_subplot(5, 1, 5, xlim=(0, 0.2), ylim=(0, 10))
